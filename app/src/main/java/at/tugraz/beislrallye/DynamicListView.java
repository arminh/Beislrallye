...
public class DynamicListView extends ListView {
    private OnListViewReorderListener listener;
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            ((StableArrayAdapter)getAdapter()).swapElements(originalItem, getPositionForView(switchView));
            ((BaseAdapter) getAdapter()).notifyDataSetChanged();
            listener.onListViewReorder(((StableArrayAdapter)getAdapter()).getItems());
    ...
    private void touchEventsEnded () {
        Log.d("DynamicListView", "touchEventsEnded");
    ...
    public void setOnListViewReorderListener(OnListViewReorderListener onListViewReorderListener) {
        this.listener = onListViewReorderListener;
    }
}